...
import {
  ImageIcon, VideoIcon, SettingsIcon, BookOpenIcon, LogoutIcon, GalleryIcon, LogoIcon, XIcon, LibraryIcon, FileTextIcon, GraduationCapIcon, TrendingUpIcon, RobotIcon, MegaphoneIcon, DatabaseIcon, WhatsAppIcon, ActivityIcon
} from './Icons';
...
const getNavItems = (language: Language): NavItem[] => {
    ...
    return [
        ...
        { id: 'master-dashboard', label: "Master Dashboard", section: 'admin', icon: ActivityIcon, roles: ['admin'] },
